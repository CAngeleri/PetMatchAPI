...
namespace MomosMatch.Migrations
{
    ...
    [Migration("20240628155401_FirstMigration3")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MomosMatch.Models.Post", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MomosMatch.Models.PostComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MomosMatch.Models.PostLike", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MomosMatch.Models.Post", b =>
                {
                    b.HasOne("MomosMatch.Models.User", "Author")
            ...
            modelBuilder.Entity("MomosMatch.Models.PostComment", b =>
                {
                    b.HasOne("MomosMatch.Models.Post", "Post")
                        .WithMany("Comments")
